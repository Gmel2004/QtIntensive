    ...
    QMainWindow(parent)
{
    ...
    propertyButton->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Fixed);
    deleteButton->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Fixed);
    insertButton->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Fixed);

    insertValueLineEdit->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Fixed);
    insertValueLineEdit->setToolTip("Введите одно значение или несколько значений, разделенных пробелом");

    deleteValueLineEdit->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Fixed);
    deleteValueLineEdit->setToolTip("Введите число для удаления");
    ...
    this->setWindowTitle("Бинарное дерево");
...
void MainWindow::createMenu()
{
    ...
    editMenu = this->menuBar()->addMenu(tr("&Редактировать"));
    editMenu->addAction(resetAction);
}

void MainWindow::createActions()
{
    resetAction = new QAction(tr("&Удалить"), this);
    resetAction->setStatusTip("Удалите БД");
...
void MainWindow::deleteClicked() const {
    ...
    if(!this->bst->deleteItem(value.toInt()))
        this->statusLabel->setText("Числа нет в дереве...");
    else
        this->statusLabel->setText("Число удалено.");
...
void MainWindow::insertClicked() const
{
    ...
    while (iterator.hasNext())
    {
        if(!this->bst->insert(iterator.next().toInt()))
            this->statusLabel->setText("Дубликат");
        else
            this->statusLabel->setText("Число вставлено");
    }
    this->renderArea->repaint();
...
{
    this->statusLabel->setText("Удалить дерево");
    this->bst->resetTree();
    this->renderArea->repaint();
    return;
}
